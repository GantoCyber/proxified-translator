...
* **[Proxychains](http://proxychains.net/)**
    * Proxychains is a proxifier, here connnected to the TOR network.
    ```
    $ sudo apt-get install proxychains libproxychains4 -y && wget https://raw.githubusercontent.com/GantoCyber/translate-shell/develop/proxychains.conf && cp -f proxychains4.conf > sudo /etc/proxychains4.conf
...
| **[Hawaiian](http://en.wikipedia.org/wiki/Hawaiian_language)** <br/> **ʻŌlelo Hawaiʻi** | **`haw`** | **[Persian](http://en.wikipedia.org/wiki/Persian_language)** <br/> **فارسی** | **`fa`** | **[Zulu](http://en.wikipedia.org/wiki/Zulu_language)** <br/> **isiZulu** | **`zu`** | 
